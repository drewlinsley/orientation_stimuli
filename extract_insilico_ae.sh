...
MODELS_DIR=ae_linear_models
MOMENTS_DIR=ae_linear_moments
OUTPUTS_DIR=ae_model_outputs
RESPONSE_DIR=../refactor_gammanet/INSILICO_AE_data
mkdir $MODELS_DIR
mkdir $MOMENTS_DIR
mkdir $OUTPUTS_DIR
...
do
    ...
    FULLFIELD_FF_CONV_MODEL=linear_models/${MODEL_NAME}_ff_tb_model.joblib
    FULLFIELD_FB_CONV_MODEL=linear_models/${MODEL_NAME}_fb_tb_model.joblib
