...
for theta in thetas:
    try:
        ...
        data = np.load("/Users/drewlinsley/Downloads/circuits/circuits_circuit_exc_{}_full_field_orientation_probe/BSDS_exc_{}_perturb_circuit_contrast_circuit_exc_{}_full_field_{}_optim.npy".format(perturb, perturb, perturb, theta))
        data = data.squeeze()
        ...
        activities = data[hh - 2: hh + 2, hw - 2: hw + 2]
        ...
        for h, w in zip(he, wi):
            ...
            try:
                ...
                diffs[h, w] = stats.kurtosis(tc.squeeze())
